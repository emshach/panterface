...
Also includes goal-setting, strategizing, and teamwork tools.''',
        ...
        data=(
            ( '0.1.0',
              ...
              ( 'settings',
                ( 'views.list.fields.intrepid',
                  ( '.notes', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='active name title description'.split(),
                  )),
                  ( '.resources', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='active name title description definition url file'\
                      .split(),
                  )),
                  ( '.products', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='active name title description defiintion url file'\
                      .split(),
                  )),
                  ( '.goals', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description status follows
                               precedes'''.split(),
                  )),
                  ( '.objectives', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description goal follows
                               precedes'''.split(),
                  )),
                  ( '.targets', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description status progress
                               objective'''.split(),
                  )),
                  ( '.strategies', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='active name title description objective'.split(),
                  )),
                  ( '.plans', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='active name title description strategy'.split(),
                  )),
                  ( '.phases', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='active name title description plan'.split(),
                  )),
                  ( '.steps', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='active name title description phase'.split(),
                  )),
                  ( '.projects', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='active name title description objective'.split(),
                  ...
                  ( '.tasks', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='active name title description project parent step'\
                      .split(),
                  )),
                  ( '.actions', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description task follows
                               precedes'''.split(),
                  )),
                  ( '.currencies', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='active name title description rate'.split(),
                  )),
                  ( '.accounts', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description currency amount
                               opened closed'''.split(),
                  )),
                  ( '.pools', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description size available
                               parent'''.split(),
                  )),
                  ( '.allotments', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='active name title description ammount account pool'\
                      .split(),
                  )),
                  ( '.allocations', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description size available opened
                               used closed end_state pool'''.split(),
                  )),
                  ( '.incomes', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description stable amount
                               intended_start actual_start intended_end
                               actual_end'''.split(),
                  )),
                  ( '.expenses', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description stable amount source
                               intended_start actual_start intended_end
                               actual_end'''.split(),
                  )),
                  ( '.assets', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description cost expense value
                                  intended_own effective_own'''.split(),
                  )),
                  ( '.donations', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='active name title description cost expense'.split(),
                  )),
                  ( '.services', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description cost expense
                               intended effective'''.split(),
                  )),
                  ( '.rentals', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description cost expense period
                               intended_start actual_start intended_end
                               actual_end'''.split(),
                  )),
                  ( '.liabilities', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description gain destination
                               value'''.split(),
                  )),
                  ( '.contributions', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                  ...
                  ( '.commissions', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description gain destination
                               intended_close effective_close'''.split(),
                  )),
                  ( '.employments', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description gain destination
                               period intended_start actual_start
                               intended_end actual_end'''.split(),
                  )),
                  ( '.investments', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description cost expense gain
                               destination'''.split(),
                  )),
                  ( '.receipts', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description amount intended
                               effective income source'''.split(),
                  )),
                  ( '.deposits', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description amount account
                               receipt'''.split(),
                  )),
                  ( '.payments', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description amount indended
                               effective expense destination'''.split(),
                  )),
                  ( '.budgets', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description start end master
                               follows precedes'''.split(),
                  )),
                  ( '.transfers', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description amount intended
                               effective budget source destination'''.split(),
                  )),
                  ( '.relocations', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description amount intended
                  ...
                  ( '.earnings', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description amount intended
                               effective budget receipt'''.split(),
                  )),
                  ( '.purchases', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description amount intended
                               effective budget payment'''.split(),
                  )),
                  ( '.teams', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='active name title description parent'.split(),
                  )),
                  ( '.positions', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='active name title description team'.split(),
                  )),
                  ( '.roles', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='active name title description'.split(),
                  ...
                  ( '.taxonomies', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='''active name title description hierarchical
                               exclusive parent'''.split(),
                  )),
                  ( '.terms', dict(
                      type=Setting.Types.MULTIPLECHOICE,
                      options='active name title description parent data'.split(),
                  )))),
              ( 'links', ),
              ( 'widgets',
                tuple(
