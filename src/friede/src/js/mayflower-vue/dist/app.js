...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "b4ff96c4a5ded935eccb";
...
vuikit_lib_button__WEBPACK_IMPORTED_MODULE_0__["ButtonLink"].props.type.validator = function (val) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  inheritAttrs: false,
  name: 'Page',
  components: _views__WEBPACK_IMPORTED_MODULE_2__["default"],
  props: [],
  mounted: function mounted() {},
  data: function data() {
    return {};
...
var FilteredMixin = {
  ...
  methods: {
    toggleSelect: function toggleSelect(object) {
      ...
      if (index > -1) this.selected.push(object);else this.selected.splice(index, 1);
    },
