# -*- coding: utf-8 -*-
# Generated by Django 1.11.18 on 2019-03-22 05:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('active', models.BooleanField(default=True)),
                ('entry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='_entries', to='friede.Location')),
            ],
            options={
                'abstract': False,
            },
